...
public:
	...
	GD_INT_DEF(AI_HOMELAND_MOVE_PRIORITY_DIPLOMAT)
	GD_INT_DEF(AI_HOMELAND_MOVE_PRIORITY_MESSENGER)
	GD_INT_DEF(MINOR_QUEST_FRIENDSHIP_WAR)
	GD_INT_DEF(MINOR_QUEST_FRIENDSHIP_FIND_CITY_STATE)
	GD_INT_DEF(MINOR_QUEST_FRIENDSHIP_INFLUENCE)
	GD_INT_DEF(MINOR_QUEST_FRIENDSHIP_TOURISM)
	GD_INT_DEF(MINOR_QUEST_FRIENDSHIP_ARCHAEOLOGY)
	GD_INT_DEF(MINOR_QUEST_FRIENDSHIP_CIRCUMNAVIGATION)
	GD_INT_DEF(IDEOLOGY_PER_CITY_UNHAPPY)
	GD_INT_DEF(IDEOLOGY_POP_PER_UNHAPPY)
	GD_INT_DEF(WARMONGER_THREAT_PER_TURN_DECAY_INCREASED)
	GD_INT_DEF(WARMONGER_THREAT_PER_TURN_DECAY_DECREASED)
	GD_INT_DEF(WARMONGER_THREAT_ATTACKED_WEIGHT_WORLD_WAR)
	GD_INT_DEF(WARMONGER_THREAT_ATTACKED_WEIGHT_WORLD_PEACE)
	GD_INT_DEF(WARMONGER_THREAT_DECREASED_WORLD_WAR)
	GD_INT_DEF(SCHOLAR_MINOR_ALLY_MULTIPLIER)
	GD_INT_DEF(SCIENCE_LEAGUE_GREAT_WORK_MODIFIER)
	GD_INT_DEF(MINOR_QUEST_REBELLION_TIMER)
	GD_INT_DEF(SPY_TO_MINOR_RATIO)
	GD_INT_DEF(BALANCE_MINOR_ANCHOR_ATTACK)
	GD_INT_DEF(BALANCE_CS_WAR_COOLDOWN_RATE)
	GD_INT_DEF(BALANCE_CS_FORGIVENESS_CHANCE)
	GD_INT_DEF(QUEST_DISABLED_WAR)
	GD_INT_DEF(QUEST_DISABLED_FIND_CITY_STATE)
	GD_INT_DEF(QUEST_DISABLED_INFLUENCE)
	GD_INT_DEF(QUEST_DISABLED_TOURISM)
	GD_INT_DEF(QUEST_DISABLED_CIRCUMNAVIGATION)
	GD_INT_DEF(QUEST_DISABLED_ARCHAEOLOGY)
	GD_INT_DEF(QUEST_DISABLED_LIBERATION)
	GD_INT_DEF(QUEST_DISABLED_HORDE)
	GD_INT_DEF(QUEST_DISABLED_REBELLION)
	GD_INT_DEF(MINOR_CIV_QUEST_WAR_MILITARISTIC_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_WAR_HOSTILE_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_WAR_CULTURED_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_NATIONAL_WONDER_CULTURED_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_FIND_CITYSTATE_MARITIME_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_FIND_CITYSTATE_MERCANTILE_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_ARCHAEOLOGY_MILITARISTIC_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_ARCHAEOLOGY_RELIGIOUS_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_CIRCUMNAVIGATION_MARITIME_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_INFLUENCE_HOSTILE_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_TOURISM_FRIENDLY_VALUE)
	GD_INT_DEF(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_LIBERATION)
	GD_INT_DEF(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_FRIENDLY_LIBERATION)
	GD_INT_DEF(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MILITARISTIC_LIBERATION)
	GD_INT_DEF(INFLUENCE_TARGET_DISTANCE_WEIGHT_VALUE)
	GD_INT_DEF(APPROACH_WAR_MINOR_QUEST_WAR)
	GD_INT_DEF(AI_MILITARY_RECAPTURING_CITY_STATE)
	GD_INT_DEF(NEED_DIPLOMAT_THRESHOLD_MODIFIER)
	GD_INT_DEF(NEED_DIPLOMAT_DESIRE_MODIFIER)
	GD_INT_DEF(NEED_DIPLOMAT_DISTASTE_MODIFIER)
	GD_INT_DEF(INFLUENCE_MINOR_QUEST_BOOST)
	GD_INT_DEF(QUEST_REBELLION_FREQUENCY)
	GD_INT_DEF(BARBARIAN_HORDE_FREQUENCY)
	GD_INT_DEF(LEAGUE_AID_MAX)
	GD_INT_DEF(CSD_GOLD_GIFT_DISABLED)
	GD_INT_DEF(CSD_DIPLO_BUILDING_YIELD)
	GD_INT_DEF(AI_GOLD_TREASURY_BUFFER)
	GD_INT_DEF(EMBASSY_IMPROVEMENT)
	GD_INT_DEF(LEAGUE_PROPOSERS_PER_SESSION)
	GD_INT_DEF(LEAGUE_NUM_LEADERS_FOR_EXTRA_VOTES)
	GD_INT_DEF(LEAGUE_PROJECT_PROGRESS_PERCENT_WARNING)
#endif

#if defined(MOD_DIPLOMACY_CIV4_FEATURES)
	GD_INT_DEF(HELP_REQUEST_TURN_LIMIT_MIN)
	GD_INT_DEF(HELP_REQUEST_TURN_LIMIT_RAND)
	GD_INT_DEF(SHARE_OPINION_TURN_BUFFER)
	GD_INT_DEF(SHARE_OPINION_RAND)
	GD_INT_DEF(SHARE_OPINION_FLAVOR_BASE)
	GD_INT_DEF(SHARE_OPINION_FLAVOR_MULTIPLIER)
	GD_FLOAT_DEF(TECH_COST_ERA_EXPONENT)
	GD_INT_DEF(VASSAL_RELIGIOUS_PRESSURE_MODIFIER)
	GD_INT_DEF(VASSAL_TOURISM_MODIFIER)
	GD_INT_DEF(VASSALAGE_VASSAL_TAX_PERCENT_MINIMUM)
	GD_INT_DEF(VASSALAGE_VASSAL_TAX_PERCENT_MAXIMUM)
	GD_FLOAT_DEF(VASSALAGE_VASSAL_CITY_POP_EXPONENT)
	GD_INT_DEF(VASSALAGE_VASSAL_UNIT_MAINT_COST_PERCENT)
	GD_INT_DEF(VASSAL_SCORE_PERCENT)
	GD_INT_DEF(VASSAL_SCIENCE_PERCENT)
	GD_INT_DEF(VASSAL_HAPPINESS_PERCENT)
	GD_INT_DEF(VASSALAGE_FREE_YIELD_FROM_VASSAL_PERCENT)
	GD_INT_DEF(VASSALAGE_PROTECT_VALUE_PER_OPINION_WEIGHT)
	GD_INT_DEF(VASSALAGE_FAILED_PROTECT_VALUE_PER_OPINION_WEIGHT)
	GD_INT_DEF(VASSALAGE_FAILED_PROTECT_CITY_DISTANCE)
	GD_INT_DEF(VASSALAGE_FAILED_PROTECT_PER_TURN_DECAY)
	GD_INT_DEF(VASSALAGE_PROTECTED_PER_TURN_DECAY)
	GD_INT_DEF(VASSALAGE_VASSAL_LOST_CITIES_THRESHOLD)
	GD_INT_DEF(VASSALAGE_VASSAL_POPULATION_THRESHOLD)
	GD_INT_DEF(VASSALAGE_VASSAL_MASTER_CITY_PERCENT_THRESHOLD)
	GD_INT_DEF(VASSALAGE_VASSAL_MASTER_POP_PERCENT_THRESHOLD)
	GD_INT_DEF(VASSALAGE_CAPITULATE_BASE_THRESHOLD)
	GD_INT_DEF(OPINION_WEIGHT_MASTER_LIBERATED_ME_FROM_VASSALAGE)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_WE_ARE_VOLUNTARY_VASSAL)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_VOLUNTARY_VASSAL_MOD)
	GD_INT_DEF(OPINION_WEIGHT_DEMANDED_WHILE_VASSAL)
	GD_INT_DEF(VASSALAGE_TREATMENT_THRESHOLD_DISAGREE)
	GD_INT_DEF(VASSALAGE_TREATMENT_THRESHOLD_MISTREATED)
	GD_INT_DEF(VASSALAGE_TREATMENT_THRESHOLD_UNHAPPY)
	GD_INT_DEF(VASSALAGE_TREATMENT_THRESHOLD_ENSLAVED)
	GD_FLOAT_DEF(OPINION_WEIGHT_VASSAL_TAX_EXPONENT)
	GD_INT_DEF(OPINION_WEIGHT_VASSAL_TAX_DIVISOR)
	GD_INT_DEF(OPINION_WEIGHT_VASSAL_CURRENT_TAX_MODIFIER)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_WE_ARE_VASSAL)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_WE_ARE_MASTER)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_THEY_PEACEFULLY_REVOKED)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_THEY_FORCIBLY_REVOKED)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_FAILED_PROTECT_MAX)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_PROTECT_MAX)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_PEACEFULLY_REVOKED_NUM_TURNS_UNTIL_FORGOTTEN)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_FORCIBLY_REVOKED_NUM_TURNS_UNTIL_FORGIVEN)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_BROKEN_VASSAL_AGREEMENT_OPINION_WEIGHT)
	GD_INT_DEF(OPINION_WEIGHT_VASSALAGE_TOO_MANY_VASSALS)
	GD_INT_DEF(APPROACH_HOSTILE_WE_ARE_VASSAL)
	GD_INT_DEF(APPROACH_GUARDED_WE_ARE_VASSAL)
	GD_INT_DEF(APPROACH_DECEPTIVE_WE_ARE_VASSAL)
	GD_INT_DEF(APPROACH_WAR_VASSAL_FORCEFULLY_REVOKED)
	GD_INT_DEF(APPROACH_DECEPTIVE_VASSAL_FORCEFULLY_REVOKED)
	GD_INT_DEF(APPROACH_FRIENDLY_VASSAL_FORCEFULLY_REVOKED)
	GD_INT_DEF(APPROACH_WAR_VASSAL_PEACEFULLY_REVOKED)
	GD_INT_DEF(APPROACH_DECEPTIVE_VASSAL_PEACEFULLY_REVOKED)
	GD_INT_DEF(APPROACH_FRIENDLY_VASSAL_PEACEFULLY_REVOKED)
	GD_INT_DEF(APPROACH_WAR_MY_VASSAL)	
	GD_INT_DEF(APPROACH_GUARDED_TOO_MANY_VASSALS)
	GD_INT_DEF(APPROACH_WAR_TOO_MANY_VASSALS)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_PATHETIC)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_WEAK)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_POOR)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_AVERAGE)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_STRONG)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_POWERFUL)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_IMMENSE)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_DISTANT)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_FAR)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_CLOSE)
	GD_INT_DEF(TARGET_VASSAL_BACKUP_NEIGHBORS)
#endif
...
#if defined(MOD_DIPLOMACY_CITYSTATES)
	GD_INT_DECL(AI_HOMELAND_MOVE_PRIORITY_DIPLOMAT);
	GD_INT_DECL(AI_HOMELAND_MOVE_PRIORITY_MESSENGER);
	GD_INT_DECL(MINOR_QUEST_FRIENDSHIP_WAR);
	GD_INT_DECL(MINOR_QUEST_FRIENDSHIP_FIND_CITY_STATE);
	GD_INT_DECL(MINOR_QUEST_FRIENDSHIP_INFLUENCE);
	GD_INT_DECL(MINOR_QUEST_FRIENDSHIP_TOURISM);
	GD_INT_DECL(MINOR_QUEST_FRIENDSHIP_ARCHAEOLOGY);
	GD_INT_DECL(MINOR_QUEST_FRIENDSHIP_CIRCUMNAVIGATION);
	GD_INT_DECL(IDEOLOGY_PER_CITY_UNHAPPY);
	GD_INT_DECL(IDEOLOGY_POP_PER_UNHAPPY);
	GD_INT_DECL(WARMONGER_THREAT_PER_TURN_DECAY_INCREASED);
	GD_INT_DECL(WARMONGER_THREAT_PER_TURN_DECAY_DECREASED);
	GD_INT_DECL(WARMONGER_THREAT_ATTACKED_WEIGHT_WORLD_WAR);
	GD_INT_DECL(WARMONGER_THREAT_ATTACKED_WEIGHT_WORLD_PEACE);
	GD_INT_DECL(WARMONGER_THREAT_DECREASED_WORLD_WAR);
	GD_INT_DECL(SCHOLAR_MINOR_ALLY_MULTIPLIER);
	GD_INT_DECL(SCIENCE_LEAGUE_GREAT_WORK_MODIFIER);
	GD_INT_DECL(PIONEER_POPULATION_CHANGE);
	GD_INT_DECL(COLONIST_POPULATION_CHANGE);
	GD_INT_DECL(MINOR_QUEST_REBELLION_TIMER);
	GD_INT_DECL(SPY_TO_MINOR_RATIO);
	GD_INT_DECL(QUEST_DISABLED_WAR);
	GD_INT_DECL(QUEST_DISABLED_FIND_CITY_STATE);
	GD_INT_DECL(QUEST_DISABLED_INFLUENCE);
	GD_INT_DECL(QUEST_DISABLED_TOURISM);
	GD_INT_DECL(QUEST_DISABLED_ARCHAEOLOGY);
	GD_INT_DECL(QUEST_DISABLED_CIRCUMNAVIGATION);
	GD_INT_DECL(QUEST_DISABLED_LIBERATION);
	GD_INT_DECL(QUEST_DISABLED_HORDE);
	GD_INT_DECL(QUEST_DISABLED_REBELLION);
	GD_INT_DECL(MINOR_CIV_QUEST_WAR_MILITARISTIC_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_WAR_HOSTILE_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_WAR_CULTURED_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_NATIONAL_WONDER_CULTURED_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_FIND_CITYSTATE_MARITIME_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_FIND_CITYSTATE_MERCANTILE_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_ARCHAEOLOGY_MILITARISTIC_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_ARCHAEOLOGY_RELIGIOUS_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_CIRCUMNAVIGATION_MARITIME_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_INFLUENCE_HOSTILE_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_TOURISM_FRIENDLY_VALUE);
	GD_INT_DECL(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_LIBERATION);
	GD_INT_DECL(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_FRIENDLY_LIBERATION);
	GD_INT_DECL(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MILITARISTIC_LIBERATION);
	GD_INT_DECL(INFLUENCE_TARGET_DISTANCE_WEIGHT_VALUE);
	GD_INT_DECL(APPROACH_WAR_MINOR_QUEST_WAR);
	GD_INT_DECL(AI_MILITARY_RECAPTURING_CITY_STATE);
	GD_INT_DECL(NEED_DIPLOMAT_THRESHOLD_MODIFIER);
	GD_INT_DECL(NEED_DIPLOMAT_DESIRE_MODIFIER);
	GD_INT_DECL(NEED_DIPLOMAT_DISTASTE_MODIFIER);
	GD_INT_DECL(INFLUENCE_MINOR_QUEST_BOOST);
	GD_INT_DECL(QUEST_REBELLION_FREQUENCY);
	GD_INT_DECL(BARBARIAN_HORDE_FREQUENCY);
	GD_INT_DECL(LEAGUE_AID_MAX);
	GD_INT_DECL(CSD_GOLD_GIFT_DISABLED);
	GD_INT_DECL(CSD_DIPLO_BUILDING_YIELD);
	GD_INT_DECL(BALANCE_GAME_DIFFICULTY_MULTIPLIER);
	GD_INT_DECL(AI_GOLD_TREASURY_BUFFER);
	GD_INT_DECL(BALANCE_MINOR_ANCHOR_ATTACK);
	GD_INT_DECL(BALANCE_CS_WAR_COOLDOWN_RATE);
	GD_INT_DECL(BALANCE_CS_FORGIVENESS_CHANCE);
	GD_INT_DECL(LEAGUE_PROPOSERS_PER_SESSION);
	GD_INT_DECL(LEAGUE_NUM_LEADERS_FOR_EXTRA_VOTES);
	GD_INT_DECL(LEAGUE_PROJECT_PROGRESS_PERCENT_WARNING);
	GD_INT_DECL(EMBASSY_IMPROVEMENT);
#endif

#if defined(MOD_DIPLOMACY_CIV4_FEATURES)
	GD_FLOAT_DECL(TECH_COST_ERA_EXPONENT);
	GD_FLOAT_DECL(VASSALAGE_VASSAL_CITY_POP_EXPONENT);
	GD_INT_DECL(HELP_REQUEST_TURN_LIMIT_MIN);
	GD_INT_DECL(HELP_REQUEST_TURN_LIMIT_RAND);
	GD_INT_DECL(SHARE_OPINION_RAND);
	GD_INT_DECL(SHARE_OPINION_FLAVOR_BASE);
	GD_INT_DECL(SHARE_OPINION_FLAVOR_MULTIPLIER);
	GD_INT_DECL(SHARE_OPINION_TURN_BUFFER);
	GD_INT_DECL(VASSALAGE_VASSAL_UNIT_MAINT_COST_PERCENT);
	GD_INT_DECL(VASSAL_SCORE_PERCENT);
	GD_INT_DECL(VASSAL_SCIENCE_PERCENT);
	GD_INT_DECL(VASSAL_HAPPINESS_PERCENT);
	GD_INT_DECL(VASSALAGE_FREE_YIELD_FROM_VASSAL_PERCENT);
	GD_INT_DECL(VASSALAGE_PROTECT_VALUE_PER_OPINION_WEIGHT);
	GD_INT_DECL(VASSALAGE_FAILED_PROTECT_VALUE_PER_OPINION_WEIGHT);
	GD_INT_DECL(VASSALAGE_FAILED_PROTECT_CITY_DISTANCE);
	GD_INT_DECL(VASSALAGE_FAILED_PROTECT_PER_TURN_DECAY);
	GD_INT_DECL(VASSALAGE_PROTECTED_PER_TURN_DECAY);
	GD_INT_DECL(VASSALAGE_VASSAL_LOST_CITIES_THRESHOLD);
	GD_INT_DECL(VASSALAGE_VASSAL_POPULATION_THRESHOLD);
	GD_INT_DECL(VASSALAGE_VASSAL_MASTER_CITY_PERCENT_THRESHOLD);
	GD_INT_DECL(VASSALAGE_VASSAL_MASTER_POP_PERCENT_THRESHOLD);
	GD_INT_DECL(VASSALAGE_CAPITULATE_BASE_THRESHOLD);
	GD_INT_DECL(VASSALAGE_VASSAL_TAX_PERCENT_MINIMUM);
	GD_INT_DECL(VASSALAGE_VASSAL_TAX_PERCENT_MAXIMUM);
	GD_INT_DECL(VASSALAGE_TREATMENT_THRESHOLD_DISAGREE);
	GD_INT_DECL(VASSALAGE_TREATMENT_THRESHOLD_MISTREATED);
	GD_INT_DECL(VASSALAGE_TREATMENT_THRESHOLD_UNHAPPY);
	GD_INT_DECL(VASSALAGE_TREATMENT_THRESHOLD_ENSLAVED);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_VOLUNTARY_VASSAL_MOD);
	GD_INT_DECL(OPINION_WEIGHT_DEMANDED_WHILE_VASSAL);
	GD_FLOAT_DECL(OPINION_WEIGHT_VASSAL_TAX_EXPONENT);
	GD_INT_DECL(OPINION_WEIGHT_VASSAL_TAX_DIVISOR);
	GD_INT_DECL(OPINION_WEIGHT_VASSAL_CURRENT_TAX_MODIFIER);
	GD_INT_DECL(OPINION_WEIGHT_MASTER_LIBERATED_ME_FROM_VASSALAGE);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_WE_ARE_VOLUNTARY_VASSAL);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_WE_ARE_VASSAL);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_WE_ARE_MASTER);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_THEY_PEACEFULLY_REVOKED);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_THEY_FORCIBLY_REVOKED);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_PROTECT_MAX);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_FAILED_PROTECT_MAX);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_PEACEFULLY_REVOKED_NUM_TURNS_UNTIL_FORGOTTEN);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_FORCIBLY_REVOKED_NUM_TURNS_UNTIL_FORGIVEN);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_BROKEN_VASSAL_AGREEMENT_OPINION_WEIGHT);
	GD_INT_DECL(OPINION_WEIGHT_VASSALAGE_TOO_MANY_VASSALS);
	GD_INT_DECL(APPROACH_HOSTILE_WE_ARE_VASSAL);
	GD_INT_DECL(APPROACH_GUARDED_WE_ARE_VASSAL);
	GD_INT_DECL(APPROACH_DECEPTIVE_WE_ARE_VASSAL);
	GD_INT_DECL(APPROACH_WAR_VASSAL_FORCEFULLY_REVOKED);
	GD_INT_DECL(APPROACH_DECEPTIVE_VASSAL_FORCEFULLY_REVOKED);
	GD_INT_DECL(APPROACH_FRIENDLY_VASSAL_FORCEFULLY_REVOKED);
	GD_INT_DECL(APPROACH_WAR_VASSAL_PEACEFULLY_REVOKED);
	GD_INT_DECL(APPROACH_DECEPTIVE_VASSAL_PEACEFULLY_REVOKED);
	GD_INT_DECL(APPROACH_FRIENDLY_VASSAL_PEACEFULLY_REVOKED);
	GD_INT_DECL(APPROACH_WAR_MY_VASSAL);
	GD_INT_DECL(APPROACH_GUARDED_TOO_MANY_VASSALS);
	GD_INT_DECL(APPROACH_WAR_TOO_MANY_VASSALS);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_PATHETIC);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_WEAK);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_POOR);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_AVERAGE);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_STRONG);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_POWERFUL);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_IMMENSE);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_DISTANT);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_FAR);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_CLOSE);
	GD_INT_DECL(TARGET_VASSAL_BACKUP_NEIGHBORS);
	GD_INT_DECL(VASSAL_RELIGIOUS_PRESSURE_MODIFIER);
	GD_INT_DECL(VASSAL_TOURISM_MODIFIER);
#endif
