...
// -- post defines --
	...
	GD_INT_INIT(AI_HOMELAND_MOVE_PRIORITY_DIPLOMAT, 100),
	GD_INT_INIT(AI_HOMELAND_MOVE_PRIORITY_MESSENGER, 100),
	GD_INT_INIT(MINOR_QUEST_FRIENDSHIP_WAR, 45),
	GD_INT_INIT(MINOR_QUEST_FRIENDSHIP_FIND_CITY_STATE, 35),
	GD_INT_INIT(MINOR_QUEST_FRIENDSHIP_INFLUENCE, 0),
	GD_INT_INIT(MINOR_QUEST_FRIENDSHIP_TOURISM, 40),
	GD_INT_INIT(MINOR_QUEST_FRIENDSHIP_ARCHAEOLOGY, 45),
	GD_INT_INIT(MINOR_QUEST_FRIENDSHIP_CIRCUMNAVIGATION, 30),
	GD_INT_INIT(IDEOLOGY_PER_CITY_UNHAPPY, 2),
	GD_INT_INIT(IDEOLOGY_POP_PER_UNHAPPY, 6),
	GD_INT_INIT(WARMONGER_THREAT_PER_TURN_DECAY_INCREASED, 20),
	GD_INT_INIT(WARMONGER_THREAT_PER_TURN_DECAY_DECREASED, 1),
	GD_INT_INIT(WARMONGER_THREAT_ATTACKED_WEIGHT_WORLD_WAR, 125),
	GD_INT_INIT(WARMONGER_THREAT_ATTACKED_WEIGHT_WORLD_PEACE, 400),
	GD_INT_INIT(WARMONGER_THREAT_DECREASED_WORLD_WAR, 5),
	GD_INT_INIT(SCHOLAR_MINOR_ALLY_MULTIPLIER, 5),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_WAR_MILITARISTIC_VALUE, 600),
	GD_INT_INIT(MINOR_CIV_QUEST_WAR_HOSTILE_VALUE, 500),
	GD_INT_INIT(MINOR_CIV_QUEST_WAR_CULTURED_VALUE, 400),
	GD_INT_INIT(MINOR_CIV_QUEST_NATIONAL_WONDER_CULTURED_VALUE, 300),
	GD_INT_INIT(MINOR_CIV_QUEST_FIND_CITYSTATE_MARITIME_VALUE, 115),
	GD_INT_INIT(MINOR_CIV_QUEST_FIND_CITYSTATE_MERCANTILE_VALUE, 115),
	GD_INT_INIT(MINOR_CIV_QUEST_ARCHAEOLOGY_MILITARISTIC_VALUE, 200),
	GD_INT_INIT(MINOR_CIV_QUEST_ARCHAEOLOGY_RELIGIOUS_VALUE, 150),
	GD_INT_INIT(MINOR_CIV_QUEST_CIRCUMNAVIGATION_MARITIME_VALUE, 250),
	GD_INT_INIT(MINOR_CIV_QUEST_INFLUENCE_HOSTILE_VALUE, 50),
	GD_INT_INIT(MINOR_CIV_QUEST_TOURISM_FRIENDLY_VALUE, 130),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_RELIGIOUS_LIBERATION, 350),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_FRIENDLY_LIBERATION, 250),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MILITARISTIC_LIBERATION, 400),
	GD_INT_INIT(INFLUENCE_TARGET_DISTANCE_WEIGHT_VALUE, 2),
	GD_INT_INIT(APPROACH_WAR_MINOR_QUEST_WAR, 2),
	GD_INT_INIT(AI_MILITARY_RECAPTURING_CITY_STATE, 200),
	GD_INT_INIT(NEED_DIPLOMAT_THRESHOLD_MODIFIER, 125),
	GD_INT_INIT(NEED_DIPLOMAT_DESIRE_MODIFIER, 1),
	GD_INT_INIT(NEED_DIPLOMAT_DISTASTE_MODIFIER, 7),
	GD_INT_INIT(INFLUENCE_MINOR_QUEST_BOOST, 20),
	GD_INT_INIT(QUEST_REBELLION_FREQUENCY, 300),
	GD_INT_INIT(BARBARIAN_HORDE_FREQUENCY, 300),
	GD_INT_INIT(LEAGUE_AID_MAX, 30),
	GD_INT_INIT(CSD_GOLD_GIFT_DISABLED, 1),
	GD_INT_INIT(CSD_DIPLO_BUILDING_YIELD, 2),
	GD_INT_INIT(BALANCE_GAME_DIFFICULTY_MULTIPLIER, 0),
	GD_INT_INIT(AI_GOLD_TREASURY_BUFFER, 500),
	GD_INT_INIT(BALANCE_MINOR_ANCHOR_ATTACK, -10),
	GD_INT_INIT(BALANCE_CS_WAR_COOLDOWN_RATE, 30),
	GD_INT_INIT(BALANCE_CS_FORGIVENESS_CHANCE, 80),
	...
	GD_FLOAT_INIT(VASSALAGE_VASSAL_CITY_POP_EXPONENT, 0.6f),
	GD_INT_INIT(HELP_REQUEST_TURN_LIMIT_MIN, 20),
	GD_INT_INIT(HELP_REQUEST_TURN_LIMIT_RAND, 10),
	GD_INT_INIT(SHARE_OPINION_RAND, 100),
	GD_INT_INIT(SHARE_OPINION_FLAVOR_BASE, 2),
	GD_INT_INIT(SHARE_OPINION_FLAVOR_MULTIPLIER, 10),
	GD_INT_INIT(SHARE_OPINION_TURN_BUFFER, 20),
	GD_INT_INIT(VASSAL_RELIGIOUS_PRESSURE_MODIFIER, 33),
	GD_INT_INIT(VASSAL_TOURISM_MODIFIER, 33),
	GD_INT_INIT(VASSALAGE_VASSAL_UNIT_MAINT_COST_PERCENT, 40),
	GD_INT_INIT(VASSAL_SCORE_PERCENT, 50),
	GD_INT_INIT(VASSAL_SCIENCE_PERCENT, 10),
	...
	GD_INT_INIT(VASSALAGE_FAILED_PROTECT_CITY_DISTANCE, 2),
	...
	GD_INT_INIT(VASSALAGE_CAPITULATE_BASE_THRESHOLD, 90),
	GD_INT_INIT(VASSALAGE_VASSAL_TAX_PERCENT_MINIMUM, 0),
	GD_INT_INIT(VASSALAGE_VASSAL_TAX_PERCENT_MAXIMUM, 30),
	GD_INT_INIT(VASSALAGE_TREATMENT_THRESHOLD_DISAGREE, -10),
	GD_INT_INIT(VASSALAGE_TREATMENT_THRESHOLD_MISTREATED, -30),
	GD_INT_INIT(VASSALAGE_TREATMENT_THRESHOLD_UNHAPPY, -60),
	GD_INT_INIT(VASSALAGE_TREATMENT_THRESHOLD_ENSLAVED, -100),
	GD_INT_INIT(OPINION_WEIGHT_MASTER_LIBERATED_ME_FROM_VASSALAGE, -50),
	GD_INT_INIT(OPINION_WEIGHT_VASSALAGE_VOLUNTARY_VASSAL_MOD, 150),
	GD_INT_INIT(OPINION_WEIGHT_DEMANDED_WHILE_VASSAL, 20),
	GD_FLOAT_INIT(OPINION_WEIGHT_VASSAL_TAX_EXPONENT, 1.5),
	GD_INT_INIT(OPINION_WEIGHT_VASSALAGE_WE_ARE_VOLUNTARY_VASSAL, 3),
	GD_INT_INIT(OPINION_WEIGHT_VASSAL_TAX_DIVISOR, -5),
	GD_INT_INIT(OPINION_WEIGHT_VASSAL_CURRENT_TAX_MODIFIER, 50),
	GD_INT_INIT(OPINION_WEIGHT_VASSALAGE_WE_ARE_VASSAL, 0),
	GD_INT_INIT(OPINION_WEIGHT_VASSALAGE_WE_ARE_MASTER, 20),
	GD_INT_INIT(OPINION_WEIGHT_VASSALAGE_THEY_PEACEFULLY_REVOKED, -40),
	...
	GD_INT_INIT(OPINION_WEIGHT_VASSALAGE_BROKEN_VASSAL_AGREEMENT_OPINION_WEIGHT, 40),
	GD_INT_INIT(OPINION_WEIGHT_VASSALAGE_TOO_MANY_VASSALS, 10),
	GD_INT_INIT(APPROACH_HOSTILE_WE_ARE_VASSAL, 1),
	GD_INT_INIT(APPROACH_GUARDED_WE_ARE_VASSAL, 1),
	GD_INT_INIT(APPROACH_DECEPTIVE_WE_ARE_VASSAL, 2),
	...
	GD_INT_INIT(APPROACH_WAR_MY_VASSAL, 60),
	GD_INT_INIT(APPROACH_GUARDED_TOO_MANY_VASSALS, 10),
	GD_INT_INIT(APPROACH_WAR_TOO_MANY_VASSALS, 10),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_PATHETIC, 0),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_WEAK, 0),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_POOR, 5),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_AVERAGE, 20),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_STRONG, 35),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_POWERFUL, 50),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_IMMENSE, 100),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_DISTANT, 100),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_FAR, 115),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_CLOSE, 150),
	GD_INT_INIT(TARGET_VASSAL_BACKUP_NEIGHBORS, 200),
#endif
...
void CvGlobals::cacheGlobals()
{
	...
	if (MOD_DIPLOMACY_CITYSTATES) {
		GD_INT_CACHE(AI_HOMELAND_MOVE_PRIORITY_DIPLOMAT);
		GD_INT_CACHE(AI_HOMELAND_MOVE_PRIORITY_MESSENGER);
		GD_INT_CACHE(MINOR_QUEST_FRIENDSHIP_WAR);
		GD_INT_CACHE(MINOR_QUEST_FRIENDSHIP_FIND_CITY_STATE);
		GD_INT_CACHE(MINOR_QUEST_FRIENDSHIP_INFLUENCE);
		GD_INT_CACHE(MINOR_QUEST_FRIENDSHIP_TOURISM);
		GD_INT_CACHE(MINOR_QUEST_FRIENDSHIP_TOURISM);
		GD_INT_CACHE(MINOR_QUEST_FRIENDSHIP_CIRCUMNAVIGATION);
		GD_INT_CACHE(IDEOLOGY_PER_CITY_UNHAPPY);
		GD_INT_CACHE(IDEOLOGY_POP_PER_UNHAPPY);
		...
		GD_INT_CACHE(WARMONGER_THREAT_DECREASED_WORLD_WAR);
		...
		GD_INT_CACHE(MINOR_CIV_QUEST_WAR_MILITARISTIC_VALUE);
		GD_INT_CACHE(MINOR_CIV_QUEST_WAR_HOSTILE_VALUE);
		GD_INT_CACHE(MINOR_CIV_QUEST_WAR_CULTURED_VALUE);
		GD_INT_CACHE(MINOR_CIV_QUEST_NATIONAL_WONDER_CULTURED_VALUE);
		GD_INT_CACHE(MINOR_CIV_QUEST_FIND_CITYSTATE_MARITIME_VALUE);
		GD_INT_CACHE(MINOR_CIV_QUEST_FIND_CITYSTATE_MERCANTILE_VALUE);
		GD_INT_CACHE(MINOR_CIV_QUEST_ARCHAEOLOGY_MILITARISTIC_VALUE);
		GD_INT_CACHE(MINOR_CIV_QUEST_ARCHAEOLOGY_RELIGIOUS_VALUE);
		GD_INT_CACHE(MINOR_CIV_QUEST_CIRCUMNAVIGATION_MARITIME_VALUE);
		GD_INT_CACHE(MINOR_CIV_QUEST_INFLUENCE_HOSTILE_VALUE);
		GD_INT_CACHE(MINOR_CIV_QUEST_TOURISM_FRIENDLY_VALUE);
		...
		GD_INT_CACHE(APPROACH_WAR_MINOR_QUEST_WAR);
		...
		GD_INT_CACHE(CSD_DIPLO_BUILDING_YIELD);
		GD_INT_CACHE(BALANCE_GAME_DIFFICULTY_MULTIPLIER);
		...
		GD_INT_CACHE(BALANCE_MINOR_ANCHOR_ATTACK);
		GD_INT_CACHE(BALANCE_CS_WAR_COOLDOWN_RATE);
		GD_INT_CACHE(BALANCE_CS_FORGIVENESS_CHANCE);
	...
	if (MOD_DIPLOMACY_CIV4_FEATURES) {
		...
		GD_INT_CACHE(SHARE_OPINION_RAND);
		GD_INT_CACHE(SHARE_OPINION_FLAVOR_BASE);
		GD_INT_CACHE(SHARE_OPINION_FLAVOR_MULTIPLIER);
		...
		GD_INT_CACHE(OPINION_WEIGHT_VASSALAGE_BROKEN_VASSAL_AGREEMENT_OPINION_WEIGHT);
		GD_INT_CACHE(OPINION_WEIGHT_VASSALAGE_TOO_MANY_VASSALS);

		GD_INT_CACHE(APPROACH_HOSTILE_WE_ARE_VASSAL);
		GD_INT_CACHE(APPROACH_GUARDED_WE_ARE_VASSAL);
		GD_INT_CACHE(APPROACH_DECEPTIVE_WE_ARE_VASSAL);
		...
		GD_INT_CACHE(APPROACH_WAR_MY_VASSAL);
		...
		GD_INT_CACHE(VASSAL_SCIENCE_PERCENT);
		...
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_PATHETIC);
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_WEAK);
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_POOR);
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_AVERAGE);
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_STRONG);
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_POWERFUL);
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_IMMENSE);
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_DISTANT);
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_FAR);
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_CLOSE);
		GD_INT_CACHE(TARGET_VASSAL_BACKUP_NEIGHBORS);
		GD_INT_CACHE(VASSAL_RELIGIOUS_PRESSURE_MODIFIER);
	}
#endif
}
