...
#if defined(MOD_DIPLOMACY_CITYSTATES)
		if(MOD_DIPLOMACY_CITYSTATES && pOldCity->isBarbarian())
		{
...
#if defined(MOD_DIPLOMACY_CITYSTATES)
	if (MOD_DIPLOMACY_CITYSTATES && GC.getGame().GetGameLeagues()->IsIdeologyEmbargoed(GetID(), eOtherPlayer) && eOtherPlayer != m_eID)
	{
		return false;
	}
#endif
